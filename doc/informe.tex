...
\subsection{{\em Artifacts} que resultan de la compresión}
...
Cuando la función objetivo presenta un cambio abrupto o
``discontinuidad'', la aproximación da lugar a un efecto de
reverberación.

Para verificar este fenómeno, se comprimió una imagen de
$200 \times 200$, con una mitad blanca y una mitad negra,
con parámetros $B = 8$, $Q = 50$, $U = 2000$.
En la imagen comprimida puede apreciarse el {\em ringing effect}
visualmente:
el borde claramente delimitado entre la mitad blanca y la mitad
negra pasa a estar contaminado por varias franjas verticales de
distintos tonos de gris.

Por otro lado, al comprimir la imagen
con $B = 100$, no debería manifestarse un {\em ringing effect},
ya que la transición entre la mitad blanca y la mitad negra no
ocurre de manera interna a un bloque.
En efecto, esto también se puede apreciar en la figura de abajo.
